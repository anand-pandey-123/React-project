...
export function Nav() {
    ...
    <nav className="w-[15%] bg-zinc-100 h-full flex items-center flex-col">
        <a href="/React-project/create" className="py-3 px-8 border-blue-300 border rounded-md mt-6 text-blue-300">Add Items</a>
        ...
        {filteredCategory.map((c, index)=>{
            return (
                <h2 key={index} className="w-[80%] flex items-center text-sm mb-2">
                    <Link to={`/React-project/?category=${c}`} className="flex items-center">
